class MiraxAIProduct {
    constructor(appId, appKey, TypeID, ProductID, lat, lang) {
      this.appId = appId;
      this.appKey = appKey;
      this.TypeID = TypeID;
  ...
  function sendDataToMiraxAIProduct(appId, appKey, TypeID, ProductID, lat, lang, callback) {
    const miraxAIProduct = new MiraxAIProduct(appId, appKey, TypeID, ProductID, lat, lang);
